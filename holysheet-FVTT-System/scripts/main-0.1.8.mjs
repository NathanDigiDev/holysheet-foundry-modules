...
import { HolySheetActorSheet } from "./sheets/actor-sheet-0.1.8.mjs";
import { HolySheetItemSheet } from "./sheets/item-sheet-0.1.8.mjs";
...
async function preloadTemplates() {
  return loadTemplates([
    "systems/holysheet/templates/actor/character-sheet-0.1.8.hbs",
    "systems/holysheet/templates/actor/npc-sheet-0.1.8.hbs",
    "systems/holysheet/templates/item/equipment-sheet-0.1.8.hbs"
  ]);
}
